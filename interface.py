...
def repondre(question, model, index, data, historique=[]):
    ...
    # Cette règle doit être la PREMIÈRE après les confirmations !
    if ("c'est quoi" in question_lower or "c est quoi" in question_lower or "c'est" in question_lower) and "inspei" in question_lower:
