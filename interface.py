...
def repondre(question, model, index, data, historique=[]):
    ...
    # --- RÈGLE : "On devenir quoi après l'INSPEI ?" ---
    if ("après" in question_lower or "devenir" in question_lower or "faire" in question_lower) and ("inspei" in question_lower or "école" in question_lower or "étudiant" in question_lower):
